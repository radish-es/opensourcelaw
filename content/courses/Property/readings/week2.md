...
To reiterate: the "vocabulary" of common law property is limited to a number of patterned argument types that come together to make what we typically call "legal arguments". Our task this week is to describe some of the main argument types that you'll encounter most frequently in property law and to practice identifying these argument types in judicial decisions.
{{% /callout %}}

## Argument Types ##

We are going to start off working with just four main argument types. Not every argument you encounter in the common law will necessarily fit into one of these types—there are no doubt others—but using only these four we can identify and characterize a surprisingly large range of common law arguments. 
...
In this approach, we will see that each "argument" we want to classify is actually made up of a couplet of "argument bites". You can think of these argument bites as "sides" of the argument, or the dynamic of opposing argument and counter-argument we normally ascribe to the plaintiff and defendant on opposite sides of a dispute.

### Denial of Premise

Denying the premise of an opposing argument bite is an attempt to undermine either the factual or normative basis of that opposing bite. Denying a factual premise might look something like this:

> Plaintiff: I have a right to exclude other people from my land.

> Defendant: Yes, but you do not own the land.

In this example, the first argument bite asserts a principle ("plaintiff has a right to exclude") based on the factual premise that plaintiff owns the land. The opposing argument bite accepts the principle, but denies the factual premise of land ownership. If plaintiff does not own the land, the asserted principle does not apply in the circumstances. 
...
Clearly, the argument pair above begs the question of whose "right" should win out under the circumstances. Nevertheless, it is important to understand that—as with each of the argument types—the point of this argumentative structure is not to resolve the dispute itself but rather to throw into relief *what the dispute is actually about*. 

### Counter-Theory 

Like in denial-of-premise-type arguments, counter-theories present a direct conflict between plaintiff's and defendant's positions. But rather than attacking an underlying premise of the opposing argument bite, counter-theory-type arguments present directly conflicting theories that favour the preferred outcomes on opposing sides. In this way, the argumentative structure can also look similar to symmetrical opposition. 

Here is a frequent example of this argument type surrounding the institutional role of common law courts:

> Plaintiff: the proper role of common law courts is to apply the law as they find it, not to make it.

> Defendant: the proper role of common law courts is to adapt to the law to meet changing conditions and the needs of society.
